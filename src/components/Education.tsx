        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="mb-24">
                    ...
                    <div className="edu-card glass-card p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 opacity-0">
                        {/* University Logo */}
                        <img
                            src="/nu-logo.png"
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-xl text-primary/80 mb-1">{education.degree}</p>
                            <p className="text-lg text-secondary mb-4">{education.specialization}</p>
                            ...
                            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                                {education.badges.map((badge, index) => (
                                    <span
                                        key={index}
                                        className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-full font-semibold dark:text-yellow-300"
                                        style={{ color: 'var(--text-badge, #000000)' }} // Fallback to black, overridable by CSS var if needed
                                    >
                                        ⭐ {badge}
                                    </span>
                                ))}
                ...
                <div className="mt-24">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        {/* EMG */}
                        <div className="edu-card glass-card overflow-hidden group cursor-pointer opacity-0 flex flex-col h-full">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors text-primary">
                                    EMG-Based Prosthetic Control
                                </h3>
                                <p className="text-secondary text-sm mb-3 line-clamp-2">Research Documentation on ESP32 Myoelectric Arms</p>
                        ...
                        <div className="edu-card glass-card overflow-hidden group cursor-pointer opacity-0 flex flex-col h-full">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <p className="text-secondary text-sm mb-3 line-clamp-2">Controlling computer devices using brainwaves</p>
                        ...
                        <div className="edu-card glass-card overflow-hidden group cursor-pointer opacity-0 flex flex-col h-full">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <p className="text-secondary text-sm mb-3 line-clamp-2">Deep Learning Algorithm for Kepler Data</p>
